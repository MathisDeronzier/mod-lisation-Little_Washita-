...
pr_CVM<-apply(pr_series, 2, CVM_pr_series)
...
layout(matrix(1:2,1,2))
plot(pr_CVM_stat[,(1:6)], main= "dist CvM pr dwnsc(blue) / deg (red)", xlab="degradations" , ylab="CvM", type="l", col="blue")
lines(pr_CVM_stat[,c(1,7,8,9,10,11)], col="red")
plot(etp_CVM_stat[,(1:6)], main= "dist CvM etp dwnsc(blue) / deg (red)", xlab="deg" , ylab="CvM", type="l")
lines(etp_CVM_stat[,c(1,7,8,9,10,11)], col="red")
```

La p-value n'est pas representative dans ce cas là. Celà est dû au fait que la précipitation possède une fonction de distribution avec une masse de Dirac en 0.
